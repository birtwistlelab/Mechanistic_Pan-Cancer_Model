...
for k in range(numcells):
    ...
    [t, xoutG, xoutS] = RunModel(flagD, th1, STIM1, xoutS_up, xoutG_up, dataS, dataG, dataG.kTCleak, dataG.kTCmaxs)

    np.savetxt('4A_output/mutation/t_'+str(k)+'_1.csv', t, delimiter=',')
    np.savetxt('4A_output/mutation/xoutG_'+str(k)+'_1.csv', xoutG, delimiter=',')
    np.savetxt('4A_output/mutation/xoutS_'+str(k)+'_1.csv', xoutS, delimiter=',')
    ...
    [t, xoutG, xoutS] = RunModel(flagD, th2, STIM2, xoutS_up, xoutG_up, dataS, dataG, dataG.kTCleak, dataG.kTCmaxs)

    np.savetxt('4A_output/mutation/t_'+str(k)+'_2.csv', t, delimiter=',')
    np.savetxt('4A_output/mutation/xoutG_'+str(k)+'_2.csv', xoutG, delimiter=',')
    np.savetxt('4A_output/mutation/xoutS_'+str(k)+'_2.csv', xoutS, delimiter=',')
